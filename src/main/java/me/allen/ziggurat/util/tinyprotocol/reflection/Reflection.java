...
public class Reflection
{
    ...
    public static String NMS_PREFIX = Reflection.OBC_PREFIX.replace("org.bukkit.craftbukkit", "net.minecraft.server");
    ...
    private static <T> FieldAccessor<T> getField(Class<?> target, String name, Class<T> fieldType, int index) {
        for (Field[] array2 : new Field[][] { target.getDeclaredFields(), target.getFields() }) {
            Field[] fields = array2;
