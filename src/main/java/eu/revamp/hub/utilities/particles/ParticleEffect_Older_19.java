package eu.revamp.hub.utilities.particles;
...
public enum ParticleEffect_Older_19 {
    ...
    private static final Map<String, ParticleEffect_Older_19> NAME_MAP;
    private static final Map<Integer, ParticleEffect_Older_19> ID_MAP;
    private final String name;
    private final int id;
    private final int requiredVersion;
    private final List<ParticleProperty> properties;

    ParticleEffect_Older_19(String name, int id, int requiredVersion, ParticleProperty... properties) {
        this.name = name;
        this.id = id;
    ...
    public static ParticleEffect_Older_19 fromName(String name) {
        for (Map.Entry<String, ParticleEffect_Older_19> entry : NAME_MAP.entrySet()) {
            if (entry.getKey().equalsIgnoreCase(name)) return entry.getValue();
        }
        return null;
    }

    public static ParticleEffect_Older_19 fromId(int id) {
        for (Map.Entry<Integer, ParticleEffect_Older_19> entry : ID_MAP.entrySet()) {
    ...
    private static boolean isLongDistance(Location location, List<Player> players) {
        ...
        for (Player player : players) {
            ...
            if (!world.equals(playerLocation.getWorld().getName())) continue;
            if (!(playerLocation.distanceSquared(location) < 65536.0)) return true;
        }
        return false;
    }

    private static boolean isDataCorrect(ParticleEffect_Older_19 effect, ParticleData data) {
        if (effect == BLOCK_CRACK || effect == BLOCK_DUST) {
            if (data instanceof BlockData) return true;
        }
        if (effect != ITEM_CRACK) return false;
        return data instanceof ItemData;
    }

    private static boolean isColorCorrect(ParticleEffect_Older_19 effect, ParticleColor color) {
        if (effect == SPELL_MOB || effect == SPELL_MOB_AMBIENT || effect == REDSTONE) {
            if (color instanceof OrdinaryColor) return true;
        }
        if (effect != NOTE) return false;
        return color instanceof NoteColor;
    }
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        if (this.hasProperty(ParticleProperty.REQUIRES_WATER) && !ParticleEffect_Older_19.isWater(center)) {
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, ParticleEffect_Older_19.isLongDistance(center, players), null).sendTo(center, players);
    }
    ...
    public void display(Vector direction, float speed, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        new ParticlePacket(this, direction, speed, ParticleEffect_Older_19.isLongDistance(center, players), null).sendTo(center, players);
    }
    ...
    public void display(ParticleColor color, Location center, double range) throws ParticleVersionException, ParticleColorException {
        ...
        if (!ParticleEffect_Older_19.isColorCorrect(this, color)) {
    ...
    public void display(ParticleColor color, Location center, List<Player> players) throws ParticleVersionException, ParticleColorException {
        ...
        new ParticlePacket(this, color, ParticleEffect_Older_19.isLongDistance(center, players)).sendTo(center, players);
    }
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
        ...
        if (!ParticleEffect_Older_19.isDataCorrect(this, data)) {
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException {
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, ParticleEffect_Older_19.isLongDistance(center, players), data).sendTo(center, players);
    }
    ...
    public void display(ParticleData data, Vector direction, float speed, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException {
        ...
        new ParticlePacket(this, direction, speed, ParticleEffect_Older_19.isLongDistance(center, players), data).sendTo(center, players);
    }
    ...
    static {
        NAME_MAP = new HashMap<String, ParticleEffect_Older_19>();
        ID_MAP = new HashMap<Integer, ParticleEffect_Older_19>();
        ParticleEffect_Older_19[] arrparticleEffect_Older_19 = ParticleEffect_Older_19.values();
        int n = arrparticleEffect_Older_19.length;
        int n2 = 0;
        while (n2 < n) {
            ParticleEffect_Older_19 effect = arrparticleEffect_Older_19[n2];
    ...
    public static final class ParticlePacket {
        ...
        private final ParticleEffect_Older_19 effect;
        ...
        public ParticlePacket(ParticleEffect_Older_19 effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
        ...
        public ParticlePacket(ParticleEffect_Older_19 effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
            this(effect, (float)direction.getX(), (float)direction.getY(), (float)direction.getZ(), speed, 0, longDistance, data);
        }

        public ParticlePacket(ParticleEffect_Older_19 effect, ParticleColor color, boolean longDistance) {
            this(effect, color.getValueX(), color.getValueY(), color.getValueZ(), 1.0f, 0, longDistance, null);
            if (effect != REDSTONE) return;
            if (!(color instanceof OrdinaryColor)) return;
            if (((OrdinaryColor)color).getRed() != 0) return;
