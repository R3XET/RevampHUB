...
public final class ReflectionUtils {
    ...
    public static Constructor<?> getConstructor(Class<?> clazz, Class<?> ... parameterTypes) throws NoSuchMethodException {
        ...
        while (n2 < n) {
            ...
            if (DataType.compare(DataType.getPrimitive(constructor.getParameterTypes()), primitiveTypes)) return constructor;
            ++n2;
        }
    ...
    public static Method getMethod(Class<?> clazz, String methodName, Class<?> ... parameterTypes) throws NoSuchMethodException {
        ...
        while (n2 < n) {
            ...
            if (method.getName().equals(methodName)) {
                if (DataType.compare(DataType.getPrimitive(method.getParameterTypes()), primitiveTypes)) return method;
            }
            ++n2;
        }
        ...
        public static boolean compare(Class<?>[] primary, Class<?>[] secondary) {
            ...
            while (index < primary.length) {
                ...
                if (!primaryClass.equals(secondaryClass)) {
                    if (!primaryClass.isAssignableFrom(secondaryClass)) return false;
                }
                ++index;
            }
            return true;
