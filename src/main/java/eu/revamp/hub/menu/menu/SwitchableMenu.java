package eu.revamp.hub.menu.menu;

import eu.revamp.hub.menu.slots.Slot;
import eu.revamp.hub.menu.slots.pages.NextPageSlot;
import eu.revamp.hub.menu.slots.pages.PageSlot;
import eu.revamp.hub.menu.slots.pages.PreviousPageSlot;
